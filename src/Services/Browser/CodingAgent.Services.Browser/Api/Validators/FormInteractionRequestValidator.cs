...
/// <summary>
/// Validator for form interaction requests
/// </summary>
public class FormInteractionRequestValidator : AbstractValidator<FormInteractionRequest>
{
    public FormInteractionRequestValidator()
    {
        RuleFor(x => x.Url)
            .NotEmpty()
